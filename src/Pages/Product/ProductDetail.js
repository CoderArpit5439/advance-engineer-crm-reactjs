...
const ProductDetail = () => {
    ...
    const images = [
        "https://themesbrand.com/velzon/html/master/assets/images/products/img-8.png",
        "https://themesbrand.com/velzon/html/master/assets/images/products/img-8.png",
        "https://themesbrand.com/velzon/html/master/assets/images/products/img-8.png",
        "https://themesbrand.com/velzon/html/master/assets/images/products/img-8.png",
    ];
                                            ...
                                            <div class="col-xl-4 col-md-8 mx-auto">
                                                <div className="product-img-slider sticky-side-div">
                                                    ...
                                                    >
                                                        {images.map((img, idx) => (
                                                            <SwiperSlide key={idx}>
                                                                <img src={img} alt={`Product ${idx}`} className="img-fluid d-block" />
                                                            </SwiperSlide>
                                                        ))}
                                                    </Swiper>
                                                        ...
                                                        {images.map((img, idx) => (
                                                            <SwiperSlide key={idx}>
                                                                <div className="nav-slide-item">
                                                                    <img src={img} alt={`Thumb ${idx}`} className="img-fluid d-block" />
                                                                </div>
                                                            </SwiperSlide>
                                                        ))}
                                                    </Swiper>
                                                            ...
                                                            <div class="mt-4">
                                                                ...
                                                                <div class="d-flex flex-wrap gap-2">
                                                                    <div data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" data-bs-original-title="Out of Stock">
                                                                        <input type="radio" class="btn-check" name="productsize-radio" id="productsize-radio1" disable />
                                                        ...
                                                        <div class="row gy-4 gx-0">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <div class="ps-lg-4">
                                                                    ...
                                                                    <div class="me-lg-n3 pe-lg-4 simplebar-scrollable-y" data-simplebar="init" style={{ maxHeight: "225px" }}><div class="simplebar-wrapper" style={{ margin: "0px -24px 0px 0px" }}><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style={{ right: "0px", bottom: "0px" }}><div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style={{ height: "auto", overflow: "hidden scroll" }}><div class="simplebar-content" style={{ padding: "0px 24px 0px 0px" }}>
