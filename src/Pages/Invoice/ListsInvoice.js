                      ...
                      <div className="avatar-sm flex-shrink-0">
                        <span className="avatar-title bg-light rounded fs-3">
                          <svg
                            ...
                            className="feather feather-file-text text-success icon-dual-success"
                          >
                      ...
                      <div className="avatar-sm flex-shrink-0">
                        <span className="avatar-title bg-light rounded fs-3">
                          <svg
                            ...
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            className="feather feather-check-square text-success icon-dual-success"
                          >
                      ...
                      <div className="avatar-sm flex-shrink-0">
                        <span className="avatar-title bg-light rounded fs-3">
                          <svg
                            ...
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            className="feather feather-clock text-success icon-dual-success"
                          >
                      ...
                      <div className="avatar-sm flex-shrink-0">
                        <span className="avatar-title bg-light rounded fs-3">
                          <svg
                            ...
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            className="feather feather-x-octagon text-success icon-dual-success"
                          >
                            ...
                            >
                              ...
                              >
                                <div className="choices__list" role="listbox">
                                  <div
                                    id="choices--idStatus-item-choice-1"
                                  ...
                                  <div
                                    id="choices--idStatus-item-choice-2"
                                  ...
                                  <div
                                    id="choices--idStatus-item-choice-5"
                                  ...
                                  <div
                                    id="choices--idStatus-item-choice-4"
                                    className="choices__item choices__item--choice choices__item--selectable"
                                    role="option"
                                    data-choice=""
                                    data-id={4}
                                  ...
                                  <div
                                    id="choices--idStatus-item-choice-6"
                                    className="choices__item choices__item--choice choices__item--selectable"
                                    role="option"
                                    data-choice=""
                                    data-id={6}
                                  ...
                                  <div
                                    id="choices--idStatus-item-choice-3"
                                    className="choices__item choices__item--choice choices__item--selectable"
                                    role="option"
                                    data-choice=""
                                    data-id={3}
                        ...
                        >
                          ...
                          >
                                  ...
                                  <ul className="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                      <a
                                        ...
                                        href="javascript:void(0);"
                                      >
                                        <i className="ri-download-2-line align-bottom me-2 text-muted" />
                                        Download
                                      </a>
                                    </li>
                            ...
                            <tr>
                              ...
                              <td className="email">metus@protonmail.org</td>
                              <td className="country">USA</td>
                              <td className="date">
                                01 Jun, 2021{" "}
                                <small className="text-muted">9:58 PM</small>
                            ...
                            <tr>
                              ...
                              <td className="email">nunc.nulla@yahoo.edu</td>
                              <td className="country">USA</td>
                              <td className="date">
                                01 Apr, 2021{" "}
                                <small className="text-muted">9:58 PM</small>
                            ...
                            <tr>
                              ...
                              <td className="email">
                                porttitor.tellus.non@yahoo.net
                              </td>
                              <td className="country">USA</td>
                              <td className="date">
                                01 Apr, 2021{" "}
                            ...
                            <tr>
                              ...
                              <td className="email">
                                lectus.sit.amet@protonmail.edu
                              </td>
                              <td className="country">USA</td>
                              <td className="date">
                                01 Apr, 2021{" "}
                            ...
                            <tr>
                              ...
                              <td className="email">
                                dictum.phasellus.in@hotmail.org
                              </td>
                              <td className="country">USA</td>
                              <td className="date">
                                01 Apr, 2021{" "}
                        ...
                        <div className="noresult" style={{ display: "none" }}>
                          <div className="text-center">
                            ...
                            <p className="text-muted mb-0">
                              We've searched more than 150+ invoices We did not
                              find any invoices for you search.
                            </p>
                          </div>
                        </div>
                      </div>
