                        ...
                        >
                          ...
                          <li class="nav-item" role="presentation">
                            <button
                              ...
                              tabindex="-1"
                            >
                              <i class="ri-truck-line fs-16 p-2 bg-primary-subtle text-primary rounded-circle align-middle me-2"></i>{" "}
                              Shipping Info
                            </button>
                          </li>
                          <li class="nav-item" role="presentation">
                            <button
                              ...
                              data-position="2"
                            >
                              <i class="ri-bank-card-line fs-16 p-2 bg-primary-subtle text-primary rounded-circle align-middle me-2"></i>{" "}
                              Payment Info
                            </button>
                          </li>
                          <li class="nav-item" role="presentation">
