                                ...
                                <div class="panel-body">
                                    <div class="btn-group">
                                        <div class="buttonexport" id="buttonlist">
                                            <a class="btn btn-add" onClick={() => navigate('/add-category')}> <i class="fa fa-plus"></i> Add Category
                                            </a>
                                        </div>
                                    </div>
                                    <div className="table-responsive">
                                        <table id="dataTableExample1" className="table table-bordered table-striped table-hover">
                                            ...
                                            <tbody>
                                                {showItems?.length > 0 ? showItems?.map((cat, i) => {
                                                    return (
                                                        <tr key={i}>
                                                            <td>
                                                                {cat.cat_image ?
                                                                    <img src={cat.cat_image} className="img-square" alt="category Image" width="50" height="50" />
                                                                    :
                                                                    <img src="assets/dist/img/default-cat.png" className="img-circle" alt="Default Image" width="50" height="50" />
                                                                }
                                                            </td>
                                                            <td>{cat.cat_name}</td>
                                                            <td>{cat.cat_code}</td>
                                                            ...
                                                            <td>
                                                                <button type="button" className="btn btn-add btn-sm" data-toggle="modal" data-target="#categoryEditModal" onClick={() => onClickEditBtn(cat)}><i className="fa fa-pencil"></i></button>
                                                                <button type="button" className="btn btn-danger btn-sm" data-toggle="modal" data-target="#categoryDeleteModal"><i className="fa fa-trash-o"></i></button>
                                                            </td>
                                                        </tr>
                                                    )
                                                }) :
                                                ...
                                                <tr>
                                                    <td colSpan={7}>
                                                        <Pagination data={fetchCategoryList} setShowItems={setShowItems} itemPerPage={20} showItems={showItems} setCurrentPage={setCurrentPageNo} currentPage={currentPageNo} totalRow={totalRow} />
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
