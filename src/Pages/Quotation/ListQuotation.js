...
const ListQuotation = () => {
  ...
  const pageNumber = localStorage.getItem("product-list");
  ...
  dispatch(GetSingleProducts({ qp_id: data?.quo_id }));
  };
                                  ...
                                  <td>
                                    <div className="d-flex gap-2">
                                      ...
                                      <button
                                        ...
                                        style={{ fontSize: "15px" }}
                                        onClick={() => getProduct(quote)}
                                      >
                                        <i className="fa fa-eye"></i> Order
                                      </button>
                                    </div>
                                  </td>
                                </tr>
        ...
        <div className="modal-dialog" style={{ width: "900px" }}>
          <div className="modal-content">
            <div className="modal-header modal-header-primary">
              ...
              <h3>
                <i className="fa fa-user m-r-5"></i> Quotation
              </h3>
            </div>
