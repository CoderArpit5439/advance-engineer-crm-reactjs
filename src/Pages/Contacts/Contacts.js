              ...
              <div className="d-flex align-items-center flex-wrap gap-2">
                <div className="flex-grow-1">
                  <button
                    ...
                    fdprocessedid="elacqn"
                  >
                    <i className="ri-add-fill me-1 align-bottom" /> Add Contacts
                  </button>
                </div>
                  ...
                  >
                    <thead className="table-light">
                      <tr>
                        ...
                        <th className="sort" data-sort="email_id" scope="col">
                          Email ID
                        </th>
                        <th className="sort" data-sort="phone" scope="col">
                          Phone No
                        </th>
                        <th className="sort" data-sort="lead_score" scope="col">
                          Lead Score
                        </th>
                        <th className="sort" data-sort="tags" scope="col">
                          Tags
                        </th>
                    ...
                    <tbody className="list form-check-all">
                      <tr>
                        ...
                        <td className="lead_score">225</td>
                        <td className="tags">
                        ...
                        <td className="date">
                          23 Apr, 2012{" "}
                          <small className="text-muted">11:55PM</small>
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td className="company_name">Meta4Systems</td>
                        <td className="email_id">kevindawson@velzon.com</td>
                        <td className="phone">745-321-9874</td>
                        <td className="lead_score">500</td>
                        <td className="tags">
                          <span className="badge bg-primary-subtle text-primary me-1">
                            Lead
                          </span>
                        ...
                        <td className="date">
                          10 Jun, 2011{" "}
                          <small className="text-muted">4:00AM</small>
                        </td>
                        <td>
                          <ul className="list-inline hstack gap-2 mb-0">
                            <li
                      ...
                      <tr>
                        ...
                        <td className="company_name">Digitech Galaxy</td>
                        <td className="email_id">tonyanoble@velzon.com</td>
                        <td className="phone">414-453-5725</td>
                        ...
                        <td className="date">
                          19 Sep, 2017{" "}
                          <small className="text-muted">12:06AM</small>
                        </td>
                        <td>
                          <ul className="list-inline hstack gap-2 mb-0">
                            <li
                      ...
                      <tr>
                        ...
                        <td className="company_name">Syntyce Solutions</td>
                        <td className="email_id">timothysmith@velzon.com</td>
                        <td className="phone">231-480-8536</td>
                        <td className="lead_score">732</td>
                        <td className="tags">
                          <span className="badge bg-primary-subtle text-primary me-1">
                            Lead
                          </span>
                      ...
                      <tr>
                        ...
                        <td className="company_name">Themesbrand</td>
                        <td className="email_id">herbertstokes@velzon.com</td>
                        <td className="phone">949-791-0614</td>
                        <td className="lead_score">784</td>
                        <td className="tags">
                          <span className="badge bg-primary-subtle text-primary me-1">
                            Exiting
                          </span>
                        ...
                        <td className="date">
                          10 May, 2012{" "}
                          <small className="text-muted">3:55PM</small>
                        </td>
                        <td>
                          <ul className="list-inline hstack gap-2 mb-0">
                            <li
                      ...
                      <tr>
                        ...
                        <td className="company_name">Micro Design</td>
                        <td className="email_id">marycousar@velzon.com</td>
                        <td className="phone">540-575-0991</td>
                        <td className="lead_score">643</td>
                        <td className="tags">
                          <span className="badge bg-primary-subtle text-primary me-1">
                            Exiting
                          </span>
                      ...
                      <tr>
                        ...
                        <td className="company_name">Themesbrand</td>
                        <td className="email_id">jamesprice@velzon.com</td>
                        <td className="phone">646-276-2274</td>
                        <td className="lead_score">81</td>
                        <td className="tags">
                          <span className="badge bg-primary-subtle text-primary me-1">
                            Lead
                          </span>
                        ...
                        <td className="date">
                          12 Nov, 2018{" "}
                          <small className="text-muted">5:55PM</small>
                        </td>
                        <td>
                          <ul className="list-inline hstack gap-2 mb-0">
                            <li
                      ...
                      <tr>
                        ...
                        <td className="company_name">Android Galaxy</td>
                        <td className="email_id">alexisclarke@velzon.com</td>
                        <td className="phone">515-395-1069</td>
                        <td className="lead_score">369</td>
                        <td className="tags">
                          <span className="badge bg-primary-subtle text-primary me-1">
                            Lead
                          </span>
                        ...
                        <td className="date">
                          12 Oct, 2018{" "}
                          <small className="text-muted">1:00AM</small>
                        </td>
                        <td>
                          <ul className="list-inline hstack gap-2 mb-0">
                            <li
                  ...
                  <div className="noresult" style={{ display: "none" }}>
                    <div className="text-center">
                      ...
                      <p className="text-muted mb-0">
                        We've searched more than 150+ contacts We did not find
                        any contacts for you search.
                      </p>
                    </div>
                  </div>
                </div>
