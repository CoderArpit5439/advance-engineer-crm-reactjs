        ...
        <div class="page-content">
          <div class="container-fluid">
                ...
                <div class="row g-2">
                  <div class="col-xl-3">
                    <div class="search-box">
                      <input
                        ...
                        autocomplete="off"
                        id="searchResultList"
                        placeholder="Search for vendors &amp; owner name or something..."
                      />{" "}
                  ...
                  <div class="col-lg-auto">
                    <div class="hstack gap-2">
                      ...
                      >
                        <i class="ri-add-fill me-1 align-bottom"></i> Add Vendor
                      </button>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-xl-3 col-lg-6">
                <div class="card ribbon-box right overflow-hidden">
                  <div class="card-body text-center p-4">
                    ...
                    <h5 class="mb-1 mt-4">
                      <a
                        href="apps-ecommerce-Vendor-details.html"
                        class="link-primary"
                      >
                        Force Medicines
                      </a>
                    ...
                    <div class="mt-4">
                      {" "}
                      <a
                        onClick={() => navigate(`/view-vendor/${1}`)}
            ...
            {/* <div id="noresult" class="d-none">
              <div class="text-center py-4">
                ...
                <p class="text-muted mb-0">
                  We've searched more than 150+ Vendor We did not find any
                  Vendor for you search.
                </p>
              </div>
            </div> */}
            ...
            <div
              ...
              id="addVendor"
              tabindex="-1"
              aria-labelledby="addVendor"
              aria-hidden="true"
            >
              <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="addVendor">
                      Add Vendor
                    </h5>
                    <button
                      type="button"
