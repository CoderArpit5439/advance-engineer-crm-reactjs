...
const AddEmployee = () => {
  ...
  const onSubmit = (data) => {
    const add = JSON.stringify(selectedOptions)
    dispatch(AddUser({data:data,allow:add}));
    // reset();
    // setTimeout(() => {
  ...
  const options = [
    { value: "Dashboard", label: "Dashboard", status: true },
    { value: "comapny", label: "comapny", status: true },
    { value: "plant", label: "plant", status: true },
    { value: "employee", label: "employee", status: true },
    { value: "customer", label: "customer", status: true },
    { value: "category", label: "category", status: true },
  ];
                              ...
                              <div className="mb-3">
                                ...
                                <div className="relative">
                                  ...
                                  <button
                                    ...
                                    className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500  align-middle"
                                  >
                                    {" "}
