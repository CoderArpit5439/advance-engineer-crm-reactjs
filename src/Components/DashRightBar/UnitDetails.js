...
import { fetchSingleUnit } from "../../Redux/crmSlices/unit/UnitSlice";

const UnitDetails = ({ uData, uId }) => {
  const dispatch = useDispatch();

  const { data, error } = useSelector((state) => {
    return {
      data: state.rootReducer.UnitSlice?.singleUnit?.data,
      error: state.rootReducer.UnitSlice?.data?.error,
    };
  });

  useEffect(() => {
    if (uData) {
      dispatch(fetchSingleUnit(uData.p_company_id));
    } else if (uId) {
      dispatch(fetchSingleUnit(uId));
    }
  }, [uData, uId]);
  ...
  return (
    <div>
      <div
        ...
        tabindex="-1"
        id="theme-settings-offcanvas-unit"
      >
        <div className="d-flex align-items-center bg-primary bg-gradient p-3 offcanvas-header">
          {/* <h5 className="m-0 me-2 text-white">{uData.company_name}</h5> */}
          <h5 className="m-0 me-2 text-white">Unit Details</h5>
                        ...
                        <div class="row mb-3">
                          <div class="col-md">
                            <div class="row align-items-center g-3">
                              ...
                              <div class="col-md">
                                <div>
                                  <h4 class="fw-bold">{data?.u_name}</h4>
                                          ...
                                          <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li>
                                              <a
                                                ...
                                                href="javascript:void(0);"
                                              >
                                                <i class="ri-download-2-fill me-2 align-bottom text-muted"></i>
                                                Download
                                              </a>
                                            </li>
